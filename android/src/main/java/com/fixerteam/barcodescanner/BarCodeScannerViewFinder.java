...
import static com.fixerteam.barcodescanner.utils.BarCodeScannerProviderKt.createBarCodeDetectorWithContext;
...
class BarCodeScannerViewFinder extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
  ...
  private void initBarCodeScanner() {
    mBarCodeScanner = createBarCodeDetectorWithContext(getContext());
    mBarCodeScannerView.onDetectorInitialized(mBarCodeScanner);
  }
